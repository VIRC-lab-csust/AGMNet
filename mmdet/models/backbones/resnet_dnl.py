...
from mmcv.cnn import (build_conv_layer, build_norm_layer, build_plugin_layer,
                      constant_init, kaiming_init, Scale, NonLocal2d)
...
class ResNet_DNL(nn.Module):
    ...
    def __init__(self,
        ...
        super(ResNet_DNL, self).__init__()
        ...
        self.dnl_block1 = DisentangledNonLocal2d(
            in_channels=1024,
            reduction=2,
            use_scale=True,
        ...
        self.dnl_block2 = DisentangledNonLocal2d(
            in_channels=2048,
            reduction=2,
            use_scale=True,
            conv_cfg=self.conv_cfg,
    ...
    def train(self, mode=True):
        ...
        freezed."""
        super(ResNet_DNL, self).train(mode)
        self._freeze_stages()
